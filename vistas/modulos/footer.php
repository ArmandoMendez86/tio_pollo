     ...
     <div class="container">
         <div class="row">
             ...
             <div class="col-md-3">
                 ...
                 <ul class="list-unstyled nav-links">
                     <li><i class="fa fa-angle-right"></i> <a href="index.html" class="footer-link">Pay
                             online</a></li>
             ...
             <div class="col-md-4">
                 ...
                 <ul class="list-unstyled contact-links">
                     ...
                     <li><i class="icon icon-phone2"></i><a href="tel:+3630123456789" class="footer-link">Phone:
                             +3630123456789</a></li>
                 </ul>
             </div>
             <div class="col-md-2">
         ...
         <div class="row">
             <div class="col-md-8">
                 <ul id="subFooterLinks">
                     ...
                     <li><a href="https://ultimatewebsolutions.net/foodboard/pdf/terms.pdf" target="_blank">Terms
                             and conditions</a></li>
                 </ul>
             </div>
             <div class="col-md-4">
